...
//		
//		 List<String> recipeUrls = Arrays.asList(
//	                "https://www.tarladalal.com/almond-biscuits-41059r",
//	                "https://www.tarladalal.com/almond-bread-homemade-almond-bread-without-eggs-41175r",
//	                "https://www.tarladalal.com/almond-pistachios-praline-triangles-1899r"
//	                // Add more recipe URLs as needed
//	        );
//
//	        IngredientsAndComorbidityInfo.init();
...
//	            processRecipe(driver, recipeUrl, elimatelist);
//	        }
//
//	        // Close the WebDriver after processing all recipes
//	        driver.quit();
//	    }
//
//	    private static void processRecipe(WebDriver driver, String recipeUrl, Map<String, List<String>> elimatelist)
//	            throws IOException {
...
////		
////		Document doc;
////		doc = Jsoup.connect("https://www.tarladalal.com/ice-cream-on-a-coconut-crust--eggless-desserts-recipe-1293r").get();
////		
////		List<String> ingredidentList = new ArrayList<>();
////		exactIngredients(doc, ingredidentList);
////		
...
//
//
//	private static LinkedList<String> getOutputFromRecipe(WebDriver driver, Document doc, List<String> targettedMorbids,List<String> ingredidentList) {
//		LinkedList<String> output = new LinkedList<>();
//		//String url = driver.getCurrentUrl();
//		String url = "https://www.tarladalal.com/ice-cream-on-a-coconut-crust--eggless-desserts-recipe-1293r";
//
